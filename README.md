...
3D WebGL viewer for Stable Diffusion Imagery with Depth Map
...
- [`@react-three/fiber`](https://github.com/react-spring/drei) &ndash; threeJs abstraction for React
- [`@tensorflow`](https://www.tensorflow.org/js/models) &ndash; Depth Estimation
